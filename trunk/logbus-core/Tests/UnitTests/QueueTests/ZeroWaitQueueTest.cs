...
namespace UnitTests
{
    ...
    /// <summary>
    ///Classe di test per ZeroWaitQueueTest.
    ///Creata per contenere tutti gli unit test ZeroWaitQueueTest
    ///</summary>
    [TestClass()]
    public class ZeroWaitQueueTest
    {
        ...
        public void ConcurrencyTest()
        {
            const int size = 3;
            _errors = 0;
            IFifoQueue<object> queue = new ZeroWaitQueue<object>(4);
