...
namespace It.Unina.Dis.Logbus.Filters
{
    ...
    [XmlRoot("MessageRegexNotMatch", Namespace = "http://www.dis.unina.it/logbus-ng/filters", IsNullable = false)]
    public class MessageRegexNotMatchFilter : MessageRegexMatchFilter
    {
        /// <remarks/>
