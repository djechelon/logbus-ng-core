...
namespace It.Unina.Dis.Logbus.Configuration
{
    ...
    [XmlRoot("logbus-client", Namespace = "http://www.dis.unina.it/logbus-ng/configuration/2.0", IsNullable = false)]
    public class LogbusClientConfiguration : XmlnsSupport
    {
